...
public class SharedStruct implements TBase<SharedStruct, SharedStruct._Fields>, java.io.Serializable, Cloneable {
  ...
  static {
    ...
    FieldMetaData.addStructMetaDataMap(SharedStruct.class, metaDataMap);
  }
